...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Header */}
      <header className="bg-resort-teal text-white px-5 py-4 sticky top-0 z-10 shadow-md">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-teal-100">👤 {staffName}</span>
            <button
      ...
      <div className="p-5 space-y-5 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="card text-center">
            <div className="text-3xl font-bold text-resort-teal">{bookings.length}</div>
            <div className="text-gray-500 text-sm mt-1 flex items-center justify-center gap-1">
              <Users size={14} /> Check-in วันนี้
            </div>
          </div>
          <div className="card text-center">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-400">
            ...
            <p className="text-sm mt-1">กด + เพื่อเพิ่ม Booking</p>
          </div>
        ) : (
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${statusColors[booking.status]}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="จาก Little Hotelier"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="date" className="input-ipad"
                value={form.check_in}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                type="number" min={1} max={10} className="input-ipad"
                value={form.num_adults}
                onChange={e => update('num_adults', parseInt(e.target.value))}
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-600 mb-1">
              ...
              <input
                type="number" min={0} max={10} className="input-ipad"
                value={form.num_children}
                onChange={e => update('num_children', parseInt(e.target.value))}
              />
            </div>
          </div>
